angular.module('ng.maltose.grid', ['ng.maltose', 'ng.maltose.exporter']).directive('maltoseGrid', function ($maltose, $maltoseExporter) {
    'use strict';
...
}).directive('maltoseGridEdit', function ($maltoseFocusOn, $timeout) {
    'use strict';
...
}).directive('maltoseGridEditSelect', function ($maltoseFocusOn, $timeout) {
    'use strict';
...
}).directive('maltoseGridEditSwitch', function ($maltoseFocusOn, $timeout) {
    'use strict';
