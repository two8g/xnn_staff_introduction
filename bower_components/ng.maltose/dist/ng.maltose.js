...
angular.module('ng.maltose').directive('maltoseDyCompile', ["$compile", function ($compile) {
    'use strict';
    return {
        replace: true,
        restrict: 'A',
...
angular.module('ng.maltose.grid', ['ng.maltose', 'ng.maltose.exporter']).directive('maltoseGrid', ["$maltose", "$maltoseExporter", function ($maltose, $maltoseExporter) {
    'use strict';
    ...
    return {
        ...
        controller: ["$scope", function ($scope) {
            ...
            $scope.onExport = function (type) {
                ...
                //}
                if (type === 'csv') {
                    $maltoseExporter.toCsv('table', data, exportColumns);
                } else if (type === 'xls') {
                    $maltoseExporter.toXls('table', data, exportColumns);
                }
...
}]).directive('maltoseGridEdit', ["$maltoseFocusOn", "$timeout", function ($maltoseFocusOn, $timeout) {
    'use strict';
    ...
    return {
        ...
        controller: ["$scope", "$element", function ($scope, $element) {
            ...
            $scope.onEdit = function (event) {
                ...
                $scope.edit = true;
                $maltoseFocusOn('maltoseGridEditInput');
            };
...
}]).directive('maltoseGridEditSelect', ["$maltoseFocusOn", "$timeout", function ($maltoseFocusOn, $timeout) {
    'use strict';
    ...
    return {
        ...
        controller: ["$scope", "$element", function ($scope, $element) {
            ...
            $scope.onEdit = function (event) {
                $element.addClass('maltose-grid-edit-on');
                $scope.edit = true;
                $maltoseFocusOn('maltoseGridEditSelect');
            };
...
}]).directive('maltoseGridEditSwitch', ["$maltoseFocusOn", "$timeout", function ($maltoseFocusOn, $timeout) {
    'use strict';
    ...
    return {
        ...
        controller: ["$scope", "$element", function ($scope, $element) {
            ...
            $scope.onEdit = function (event) {
                $element.addClass('maltose-grid-edit-on');
                $scope.edit = true;
                $maltoseFocusOn('maltoseGridEditSwitch');
            };
...
angular.module('ng.maltose.exporter', []).factory('$maltoseExporter', function () {
    'use strict';
...
angular.module('ng.maltose').factory('$maltoseFocusOn', ["$rootScope", "$timeout", function ($rootScope, $timeout) {
    'use strict';
...
angular.module('ng.maltose.uploader', []).service('$maltoseUploader', ["$log", "$q", function ($log, $q) {
    'use strict';
    ...
    var Upload = function (container, config) {
        ...
        var _config = $.extend({
            ...
            height: 37,
            buttonText: '上传',
            buttonClass: 'maltose-btn-upload',
